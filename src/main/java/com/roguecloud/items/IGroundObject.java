...
/** 
 * Represents an object laying on the ground at an in-world coordinate (e.g., it is not in someone's inventory, or in a container).
 * 
...
public interface IGroundObject extends IExistsInWorld {
	...
	/** 
	 * Method to get a unique object ID. 
	 */
	public long getId();
